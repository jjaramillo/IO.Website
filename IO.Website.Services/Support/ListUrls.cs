...
namespace IO.Website.Services.Support
{
    internal class ListUrls
    {
        internal const string DEMO_REQUESTS_URL = "Lists/DemoRequests";
        internal const string CONTACT_REQUESTS_URL = "Lists/ContactRequests";
