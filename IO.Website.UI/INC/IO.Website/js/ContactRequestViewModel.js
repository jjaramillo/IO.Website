...
var ContactRequestViewModel = function () {
    ...
    this.otherSubject = ko.observable('').extend({ required: true });
    this.formvisible = ko.observable(true);
    this.messagevisible = ko.observable(false);
    this.othersubjectvisible = ko.observable(false);
    ...
    this.Save = function () {
        if (_self.isValid() === true) {
            ...
            $.ajax(
                {
                    cache: false,
                    url: _siteCollectionUrl + '/layouts/_vti_bin/IO.Website.API/ContactRequestService.svc/Add',
                    type: 'PUT',
                    ...
                    data: ko.toJSON({
                        ...
                        otherSubject: _self.otherSubject(),
    ...
    this.subjectChange = function () {
        _self.othersubjectvisible(_self.subject() === 'Otro');
    }
}